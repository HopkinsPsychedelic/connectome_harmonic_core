...
parser.add_argument('-p','--parc', type = str, help = "path to parcellation file as vtk with %s for hem")
parser.add_argument('-n', '--number', type = str, help = 'number of evecs to compute')
