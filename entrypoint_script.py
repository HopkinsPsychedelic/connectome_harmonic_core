...
parser.add_argument('--derivatives_dir', type = str, help = 'Directory containing fMRIprep, Freesurfer, MRtrix3, and Ciftify output directories. Required for CHAP-BIDS pipeline')
