...
def hcp_prep_for_ch(args, sub, u, multises, ses):  
    ...
    if os.path.exists(f'{args.output_dir}/chap/sub-{sub}/{ses}/mrtrix/{args.streamlines}_endpoints.vtk'): #endpoints have been generated previously, skip mrtrix pipeline
        ...
        os.system(f'bash /home/neuro/repo/own5tt.sh {diffusion_dir}/data.nii.gz {diffusion_dir}/bvals {diffusion_dir}/bvecs  {diffusion_dir}/nodif_brain_mask.nii.gz {args.5tt} {args.output_dir}/chap/sub-{sub}/{ses}/mrtrix {args.streamlines}')
