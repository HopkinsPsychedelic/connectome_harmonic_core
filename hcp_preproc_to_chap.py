...
def prep_for_cs(args, sub, user_info, multises, ses):   
    ...
    for n in ['1','2']:
        user_info[f'{sub}_info'][ses][f'rest{n}_lr'] = f'{args.output_dir}/hcp_preproc/sub-{sub}/{ses}/REST{n}/{sub}/MNINonLinear/Results/rfMRI_REST{n}_LR/rfMRI_REST{n}_LR_Atlas_hp2000_clean.dtseries.nii'
        user_info[f'{sub}_info'][ses][f'rest{n}_rl'] = f'{args.output_dir}/hcp_preproc/sub-{sub}/{ses}/REST{n}/{sub}/MNINonLinear/Results/rfMRI_REST{n}_RL/rfMRI_REST{n}_RL_Atlas_hp2000_clean.dtseries.nii'
