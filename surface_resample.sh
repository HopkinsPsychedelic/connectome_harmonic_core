...
#Changed directory for local testing, TODO: change back for production
/home/quintin_frerichs/connectome_harmonic_core/BuildSphericalInterpolationMapping ${subsurfdir}/lh.sphere.reg.vtk ${refspheredir}/lh.sphere.ico5.reg.vtk ${subsurfdir}/lh.mapping.vtk

/home/quintin_frerichs/connectome_harmonic_core/BuildSphericalInterpolationMapping ${subsurfdir}/rh.sphere.reg.vtk ${refspheredir}/rh.sphere.ico5.reg.vtk ${subsurfdir}/rh.mapping.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/lh.white.vtk ${subsurfdir}/lh.mapping.vtk ${subsurfdir}/lh.white.corresponded.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/rh.white.vtk ${subsurfdir}/rh.mapping.vtk ${subsurfdir}/rh.white.corresponded.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/lh.midthickness.vtk ${subsurfdir}/lh.mapping.vtk ${subsurfdir}/lh.midthickness.corresponded.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/rh.midthickness.vtk ${subsurfdir}/rh.mapping.vtk ${subsurfdir}/rh.midthickness.corresponded.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/lh.pial.vtk ${subsurfdir}/lh.mapping.vtk ${subsurfdir}/lh.pial.corresponded.vtk

/home/quintin_frerichs/connectome_harmonic_core/ShapeInterpolation ${subsurfdir}/rh.pial.vtk ${subsurfdir}/rh.mapping.vtk ${subsurfdir}/rh.pial.corresponded.vtk
